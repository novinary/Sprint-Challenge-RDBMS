...
RDBMS is the relational database management system that stores all of our databases, and structures databases as tables made of rows and columns. 
SQL is the Structure Query Language used to interact with the database.  
...
1. What do we need in order to have a _many to many_ relationship between two tables.
 you need a third table to act as the middle-man between them; the middle-man table will have foreign keys referencing the two other tables.
